# Contributing to fluent-bit-out-hsdp

We'd love for you to contribute to our source code and to make the fluent-bit-out-hsdp even better than it is today!
...
In Github, send a pull request to original master branch: f.e. `fluent-bit-out-hsdp:master`.
...
[github]: https://github.com/philips-software/fluent-bit-out-hsdp/issues 
